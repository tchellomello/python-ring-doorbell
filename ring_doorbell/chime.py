...
class RingChime(RingGeneric):
    ...
    def linked_tree(self) -> Dict[str, Any]:
        ...
        return self._ring.auth._run_async_on_event_loop(self.async_linked_tree())
    ...
    def test_sound(self, kind: Union[RingEventKind, str] = RingEventKind.DING) -> bool:
        ...
        return self._ring.auth._run_async_on_event_loop(self.async_test_sound(kind))

    async def async_test_sound(
        self, kind: Union[RingEventKind, str] = RingEventKind.DING
    ) -> bool:
        """Play chime to test sound."""
